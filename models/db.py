...
class SederSegment(Base, TimestampMixin):
    ...
    relation_label: Mapped[str | None] = mapped_column(String(256), nullable=True)
    start_quote: Mapped[str | None] = mapped_column(Text, nullable=True)
    end_quote: Mapped[str | None] = mapped_column(Text, nullable=True)
    status_he: Mapped[str | None] = mapped_column(String(32), nullable=True)
    status_ru: Mapped[str | None] = mapped_column(String(32), nullable=True)
