...
from brain_service.core.dependencies import get_auth_service, get_settings, get_user_service
...
async def login(
    ...
    return LoginResponse(access_token=access_token, user=_build_user_payload(user))
